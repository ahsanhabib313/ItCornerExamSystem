    ...
    <div id="app">
        <aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
            <section class="sidebar">
                ...
                <hr>
                <div class="relative">
                    <a data-toggle="collapse" href="index.html#userSettingsCollapse" role="button" aria-expanded="false" aria-controls="userSettingsCollapse" class="btn-fab btn-fab-sm absolute fab-right-bottom fab-top btn-primary shadow1 ">
                    ...
                    <div class="user-panel p-3 light mb-2">
                        ...
                        <div class="collapse multi-collapse" id="userSettingsCollapse">
                            <div class="list-group mt-3 shadow">
                                ...
                                <a href="index.html#" class="list-group-item list-group-item-action"><i class="mr-2 icon-cogs text-yellow"></i>Settings</a>
                                <a href="index.html#" class="list-group-item list-group-item-action"><i class="mr-2 icon-security text-purple"></i>Change Password</a>
                            </div>
                        </div>
                    </div>
                </div>
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview"><a href="index.html#">
                            <i class="icon icon-sailing-boat-water purple-text s-18"></i> <span>Set Questions</span> <i class="icon icon-angle-left s-18 pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href=""><i class="icon icon-add"></i>Add New Questions</a></li>
                            <li><a href=""><i class="icon icon-cog"></i>Show Questions</a></li>
                            <li><a href=""><i class="icon icon-cog"></i>Set Question Limit</a></li>
                        </ul>
                    </li>
                    <li class="treeview"><a href="index.html#">
                            <i class="icon icon-account_box blue-text s-18"></i>
                            <span>Candidate</span>
                            <span class="badge r-3 badge-primary pull-right">4</span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="panel-page-products.html"><i class="icon icon-circle-o"></i>All Candidate</a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="index.html#">
                            <i class="icon icon-sailing-boat-water purple-text s-18"></i> <span>Set Category</span> <i class="icon icon-angle-left s-18 pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href=""><i class="icon icon-plus"></i>Add New Category</a>
                            </li>
                            <li><a href="panel7-inbox.html"><i class="icon icon-circle-o"></i>All Category</a>
                            </li>
                        </ul>
                    </li>

                    <li class="treeview no-b"><a href="index.html#">
                            <i class="icon icon-package light-green-text s-18"></i>
                            <span>Results</span>
                            <span class="badge r-3 badge-success pull-right">20</span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="panel-page-inbox.html"><i class="icon icon-circle-o"></i>All Result</a>
                            </li>
                            <li><a href="panel7-inbox.html"><i class="icon icon-circle-o"></i>Todays Result</a>
                            </li>
                            <li><a href="view-cv"><i class="icon icon-circle-o"></i>view cv</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="pos-f-t">
                <div class="collapse" id="navbarToggleExternalContent">
                    <div class="bg-dark pt-2 pb-2 pl-4 pr-2">
                        ...
                        <a href="index.html#" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation" class="paper-nav-toggle paper-nav-white active "><i></i></a>
                    </div>
                </div>
            </div>
            <div class="sticky">
